...
//RECURSIVE FIGHT OR SKIP FUNCTION
var fightOrSkip = function() {
    ...
    if (promptFight === "skip") {
        ...
        if (confirmSkip) {
            ...
            // subtract money from playerMoney for skipping, but don't let them go into teh negative
...
var fight = function(enemy) {
    ...
    while (playerInfo.health > 0 && enemy.health > 0) {
        if (isPlayerTurn) {
            //Asking player if they would like to fight or skip using fightOrSkip function
            if (fightOrSkip()) {
...
//PLAYER INFO OBJECT INITIALIZATION!!! in start() game
var playerInfo = {
    name: getPlayerName(),
    health: 100,
    attack: 10,
